...
export default function TopicBrowse() {
  ...
  const topicBtn = {
    padding: '1rem',
    width: '100%', // changed from min(330px, 90%) to fill grid cell like original tiling
    borderRadius: '10px',
    border: 'none',
    background: '#ffffff',
    color: '#001f62',
    ...
    >
      ...
      <section
        style={{
          ...
          marginTop: '2.8rem',
          padding: '0 1rem',
          paddingBottom: '6rem', // room above fixed buttons
          boxSizing: 'border-box',
        }}
      >
        <div
